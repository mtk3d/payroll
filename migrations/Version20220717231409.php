...
final class Version20220717231409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE report_line_read_model (id CHAR(36) NOT NULL, employee_id CHAR(36) DEFAULT NULL, report_id CHAR(36) DEFAULT NULL, first_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, department VARCHAR(255) DEFAULT NULL, base_salary VARCHAR(255) DEFAULT NULL, bonus VARCHAR(255) DEFAULT NULL, bonus_type VARCHAR(255) DEFAULT NULL, salary VARCHAR(255) DEFAULT NULL, INDEX REPORT_LINE_READ_MODEL_ID_INDEX (id), INDEX REPORT_LINE_READ_MODEL_REPORT_ID_INDEX (report_id), UNIQUE INDEX UNIQUE_REPORT_LINE_READ_MODEL_REPORT_EMPLOYEE_INDEX (report_id, employee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
