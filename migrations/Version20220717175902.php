...
final class Version20220717175902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employment_employee (id CHAR(36) NOT NULL COMMENT \'(DC2Type:employee_id)\', department_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:department_id)\', first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, INDEX IDX_A24E9E9EAE80F5DF (department_id), INDEX IDX_A24E9E9EBF396750 (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
