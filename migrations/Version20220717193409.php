...
final class Version20220717193409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE department_read_model (id CHAR(36) NOT NULL, name VARCHAR(255) DEFAULT NULL, bonus_type VARCHAR(255) DEFAULT NULL, INDEX DEPARTMENT_READ_MODEL_ID_INDEX (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
