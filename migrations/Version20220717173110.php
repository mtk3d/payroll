...
final class Version20220717173110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE salary_employee (id CHAR(36) NOT NULL COMMENT \'(DC2Type:employee_id)\', department_id CHAR(36) DEFAULT NULL COMMENT \'(DC2Type:department_id)\', employment_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', base_salary_amount VARCHAR(255) NOT NULL, base_salary_currency_code VARCHAR(3) NOT NULL, UNIQUE INDEX UNIQ_CFDAFFA0AE80F5DF (department_id), INDEX IDX_CFDAFFA0BF396750 (id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
